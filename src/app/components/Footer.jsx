...
const Footer = () => {
  return (
    <>
      <footer className='flex justify-between w-full h-fit py-[60px] px-[50px] bg-[#7DA183]'>
        <div className='flex flex-col'>
          ...
          <Link className='flex items-center justify-center gap-[6px] w-[150px] h-[40px] py-[10px] px-[22px] bg-white text-[#7DA183] shadow-md font-semibold rounded-md hover:shadow-lg hover:bg-[#A4DBAE] transition-colors mb-[40px] hover:text-black'
            ...
            <h3 className='font-medium text-[#D9D9D9] mb-[20px]'>Or email us at</h3>
            <Link className='flex items-center justify-center gap-[6px] w-fit h-[40px] py-[10px] px-[22px] bg-white text-[#7DA183] shadow-md font-semibold rounded-md hover:shadow-lg hover:bg-[#A4DBAE] transition-colors mb-[40px] hover:text-black'
              href={'/'}>
        ...
        <h1 className='font-normal text-[#D9D9D9]'>© Checkmate 2026. All rights reserved.</h1>
      </footer>
    </>
  )
}
